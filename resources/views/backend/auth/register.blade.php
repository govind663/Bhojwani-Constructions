                    ...
                    <div class="login-main">
                        <div style="align-items: center; justify-content: center; display: flex;">
                            <a class="logo text-start" href="{{ route('admin.register.store') }}">
                                <img class="img-fluid for-dark" src="{{ asset('frontend/assets/images/Bhojwani-logo.png') }}" alt="looginpage" style="height: 100px; width: 150px;">
                                <img class="img-fluid for-light" src="{{ asset('frontend/assets/images/Bhojwani-logo.png') }}" alt="looginpage" style="height: 100px; width: 150px;">
                            </a>
                        </div>
